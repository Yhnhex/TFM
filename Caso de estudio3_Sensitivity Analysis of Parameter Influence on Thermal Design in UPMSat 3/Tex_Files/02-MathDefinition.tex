...
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{Figures/FPGA-model.png}
...
Following the algorithm, the reduced Jacobian matrix is used to obtain the influence matrix. In this case, the deviation used to compute this matrix was taken from \cite{amd2024}, and it can be seen on \autoref{tab:deviationGLsFPGA}
